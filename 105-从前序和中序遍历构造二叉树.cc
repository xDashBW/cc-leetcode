...
//   TreeNode *dps_buildtree(std::vector<int> &preorder, int preindex,
//                           std::vector<int> &inorder, int inindex) {
//     if () {
//       return nullptr;
//     }
//     TreeNode *node = new TreeNode(preorder[preindex]);
//     node->left = dps_buildtree(preindex, preindex + 1, inindex, );
//     node->right = dps_buildtree();
//     return node;
//   }
...
//     TreeNode *root = dps_buildtree(preorder, 0, inorder, 0);
//     return root;
//   }
// };
